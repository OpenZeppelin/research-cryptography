...
\begin{document}
    ...
    \begin{frame}{Verifying satisfying polynomials}
        \begin{itemize}
            ...
            \item Similarly, if Bob sends \enc{3R$_1$(s)}, \enc{$\gamma\cdot$3R$_1$(s)}, ..., \enc{O$_1$(s)}, \enc{$\delta\cdot$O$_1$(s)}, ..., Alice can return a putative \enc{R(s)} and \enc{O(s)}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Verifying simultaneous satisfying polynomials}
        ...
        \begin{itemize}
            ...
            \enc{c$_1$(L$_1$+R$_1$+O$_1$)(s) + c$_2$(L$_2$+R$_2$+O$_2$)(s) + ...} = \\
            \enc{(c$_1$L$_1$+c$_2$L$_2$+...)+(c$_1$R$_1$+c$_2$R$_2$+...)+(c$_1$O$_1$+c$_2$O$_2$+...)}=\\
            \enc{L(s)+R(s)+O(s)}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{External constraints}
        ...
        \begin{itemize}
            ...
            \item If \enc{$\beta\cdot$L$_5$(s)} is not published then the \enc{c$_5$L$_5$} term cannot exist
            \item The verifier can just add \enc{90L$_5$(s)} to complete the polynomial
