...
\newcommand{\bOne}[0]{{\textcolor{LimeGreen}{b_1(x)}}}
\newcommand{\bTwo}[0]{{\textcolor{Plum}{b_2(x)}}}
% in common text scenarios, the subscript needs to be wrapped in a math environment
\newcommand{\bOneMathSub}[0]{{\textcolor{LimeGreen}{b$_1$(x)}}}
\newcommand{\bTwoMathSub}[0]{{\textcolor{Plum}{b$_2$(x)}}}
...
\begin{document}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \begin{itemize}
                    ...
                    \item[]
                    \item[3.] Sends \pub{\priv{x} + c$\cdot$\priv{r}}
                    \item[]
                \end{itemize}
            \end{column}
            \begin{column}{0.5\textwidth}
    ...
    \begin{frame}{Quadratic Arithmetic Program}
        Encode the \textbf{terms on the left of the multiplication} as a polynomial equation\\
        \vspace{0.3cm}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                $\rightarrow$
                \begin{pmatrix}
                    \pub{0} \\ \priv{c$_2$}\pub{1}\bOne \\ \pub{0} \\ \pub{0} \\ \pub{0}
                \end{pmatrix}
            \end{column}
            \begin{column}{0.5\textwidth}
                \pub{\begin{bmatrix}
                ...
                $\rightarrow$
                \begin{pmatrix}
                    \pub{0} \\ \priv{c$_2$}\pub{1}\bTwo \\ \priv{c$_3$}\pub{1}\bTwo \\ \priv{c$_4$}\pub{1}\bTwo \\ \pub{0}
                \end{pmatrix}
            \end{column}
        \end{columns}
        \begin{center}
            \priv{L} = \priv{c$_2$}(\pub{1}\bOneMathSub + \pub{1}\bTwoMathSub) + \priv{c$_3$}\pub{1}\bTwoMathSub + \priv{c$_4$}\pub{1}\bTwoMathSub \\
            \priv{R} = \ldots \\
            \priv{O} = \ldots \\
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Completed QAP}
        \bOneMathSub = 2 - x \\
        \bTwoMathSub = x - 1\\
        \priv{L} = \priv{c$_2$}\bOneMathSub + (\priv{c$_2$} + \priv{c$_3$} + \priv{c$_4$})\bTwoMathSub \\
        \priv{R} = \priv{c$_2$}\bOneMathSub + (3\priv{c$_1$} + \priv{c$_3$} + \priv{c$_4$})\bTwoMathSub \\
        \priv{O} = \priv{c$_4$}\bOneMathSub + \priv{c$_5$}\bTwoMathSub\\
        \vspace{0.5cm}
    ...
    \begin{frame}{Building blocks}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                \textbf{Bob}
                \begin{itemize}
                    \item Generates \priv{$\alpha$}, \priv{a}, \priv{b}, \priv{c}, \ldots
                    \item Sends (\enc{a}, \enc{$\alpha \cdot$a}, \enc{b}, \enc{$\alpha \cdot$b}, \ldots)
                    \item[]
                    \item[]
        ...
        \begin{center}
            How can she do this?\\
            \pause
            Alice returned a linear combination of \enc{a}, \enc{b}, \enc{c}, \ldots
        \end{center}
    \end{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                ...
                \begin{itemize}
                    ...
                    \item Sends (\enc{1}, \enc{$\alpha$}, \enc{s}, \enc{$\alpha \cdot$s}, \enc{s$^2$}, \ldots)
                    \item[]
                    \item[]
                    \item[] \item Confirms returned pair is valid
                \end{itemize}
    ...
    \begin{frame}{Verifying satisfying polynomials}
        \begin{itemize}
            ...
            \item So Bob sends \enc{u$_1$L$_1$(s)}, \enc{$\beta\cdot$u$_1$L$_1$(s)}, \enc{u$_2$L$_2$(s)}, \ldots
            \item Then Alice can return a putative \enc{L(s)} (and \enc{$\beta\cdot$L(s)})
            \item Similarly, if Bob sends \enc{v$_1$R$_1$(s)}, \enc{$\gamma\cdot$v$_1$R$_1$(s)}, \ldots, \enc{O$_1$(s)}, \enc{$\delta\cdot$O$_1$(s)}, \ldots, Alice can return a putative \enc{R(s)} and \enc{O(s)}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Verifying simultaneous satisfying polynomials}
        ...
        \begin{itemize}
            \item Bob sends \enc{(u$_1$L$_1$+v$_1$R$_1$+O$_1$)(s)}, \enc{$\epsilon$\cdot(u$_1$L$_1$+v$_1$R$_1$+O$_1$)(s)}, \ldots
            \item Alice returns \enc{L(s)+R(s)+O(s)}
            \item The logic here is that Alice has now returned:\\
            \enc{c$_1$(u$_1$L$_1$+v$_1$R$_1$+O$_1$)(s) + c$_2$(u$_2$L$_2$+u$_2$R$_2$+O$_2$)(s) + \ldots} = \\
            \enc{(c$_1$u$_1$L$_1$+c$_2$u$_2$L$_2$+\ldots)+(c$_1$v$_1$R$_1$+c$_2$v$_2$R$_2$+\ldots)+(c$_1$O$_1$+c$_2$O$_2$+\ldots)}=\\
            \enc{L(s)+R(s)+O(s)}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Non-interactive proofs}
        ...
        \begin{itemize}
            \item Generate \priv{s} and publish encrypted powers: \enc{1}, \enc{s}, \enc{s$^2$}, \ldots
